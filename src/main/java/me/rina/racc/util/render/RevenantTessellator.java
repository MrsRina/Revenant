...
// Revenant Util.
import me.rina.racc.util.render.GeometryMasks;
...
{
    public static RevenantTessellator INSTANCE = new RevenantTessellator();
    private static final Minecraft mc = Minecraft.getMinecraft();

    public RevenantTessellator(){
        super(0x200000);
    }
    ...
    public static void drawBox(AxisAlignedBB bb, RVColor color, int sides) {
        drawBox(INSTANCE.getBuffer(), bb, color, sides);
    }

    public static void drawBox(BlockPos blockPos, RVColor color, int sides) {
        drawBox(INSTANCE.getBuffer(), blockPos.getX(), blockPos.getY(), blockPos.getZ(), 1, 1, 1, color, sides);
    }

    public static void drawBox(BufferBuilder buffer, AxisAlignedBB bb, RVColor color, int sides) {
    ...
    public static void drawDownBox(BlockPos blockPos, RVColor color, int sides) {
    ...
    public static void drawBoundingBox(final AxisAlignedBB bb, final float width, RVColor color) {
    ...
    public static void drawBoundingBoxBlockPos2(BlockPos bp, float width, RVColor color) {
        int r=color.getRed(), g=color.getGreen(), b=color.getBlue(), alpha=color.getAlpha();
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
    ...
    public static void drawBoundingBoxBottom2(BlockPos bp, float width, RVColor color) {
        int red=color.getRed(), green=color.getGreen(), blue=color.getBlue(), alpha=color.getAlpha();
        GlStateManager.pushMatrix();
        GlStateManager.enableBlend();
        GlStateManager.disableDepth();
