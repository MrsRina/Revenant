...
public class TurokRenderGL {
    ...
    public static void drawUpTriangule(float x, float y, float width, float height, int offsetX) {
    ...
    public static void drawDownTriangule(float x, float y, float width, float height, int offsetX) {
        GL11.glEnable(GL11.GL_BLEND);
        GL11.glBlendFunc(GL11.GL_SRC_ALPHA, GL11.GL_ONE_MINUS_SRC_ALPHA);
